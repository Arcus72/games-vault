    ...
    <main className="chat">
      ...
      <div className="chat__main">
        ...
        {messages.length === 0 ? (
          <div className="chat-empty">
            <div className="chat-empty__chest">
              <img className="chat-empty__chest-img" src="/assets/chest-big.svg" alt="" />
            </div>
            ...
            <div className="try-asking">
              <header className="try-asking__header">
                <img className="try-asking__sparkle" src="/assets/sparkle.svg" alt="" />
                <span>SPRÓBUJ ZAPYTAĆ</span>
              </header>
              {SUGGESTIONS.map((s, i) => (
                <button className="try-asking__item" key={i} onClick={() => send(s)}>
                  <span className="try-asking__icon">
                    <img className="try-asking__icon-img" src="/assets/gamepad.svg" alt="" />
                  </span>
                  {s}
                </button>
              ))}
        ...
        >
          ...
          >
            <img className="chat-input__category-img" src="/assets/category.svg" alt="" />
          ...
          <button type="submit" className="chat-input__send" aria-label="Wyślij">
            <img className="chat-input__send-img" src="/assets/send.svg" alt="" />
          </button>
        </form>
      </div>
    </main>
